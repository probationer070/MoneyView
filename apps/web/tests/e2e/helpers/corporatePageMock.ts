  ...
  const comparisonRowsByUniverse = (comparisonUniverse: string, benchmarkTicker: string, customTickers: string[]) => {
    ...
    const baseRows = [
      ...
      },
      {
        ...
        market_expected_return: 9.7,
        market_implied_return: 10.3 + 9.7,
        implied_return_spread: 10.3,
        implied_return_refusal: null,
        dcf_refusal: null,
        stock_expected_return_source: "dcf_implied_upside",
        has_price_data: true,
      },
      {
        ...
        market_expected_return: 9.7,
        // A missing bridge is always refused: there is no market EV to solve against.
        market_implied_return: null,
        implied_return_spread: null,
        implied_return_refusal: "bridge_unresolved",
        dcf_refusal: null,
        stock_expected_return_source: "dcf_implied_upside",
        has_price_data: true,
      },
      {
        ...
        wacc: 11,
        roic_minus_wacc: -15,
        // A resolved bridge but zero-or-negative forecast FCFF: the DCF refuses rather than
        // valuing the company at the old $1B floor (spec 2026-09-26-dcf-fcff-floor-removal).
        dcf_value: null,
        bridge_quality: "ok",
        current_price: CORPORATE_COMPARISON_CURRENT_PRICES.BURN,
        dcf_implied_return: null,
        capm_expected_return: 12.0,
    ...
    if (comparisonUniverse === "watchlist_plus_benchmark") {
      return [
        ...baseRows,
        {
          ...
          market_expected_return: 9.7,
          market_implied_return: -3.76 + 9.7,
          implied_return_spread: -3.76,
          implied_return_refusal: null,
          dcf_refusal: null,
          stock_expected_return_source: "dcf_implied_upside",
          has_price_data: true,
